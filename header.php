         ...
         <div class="container">
            ...
            <div class="col-md-3 top-middle">
               <ul>
                  ...
                  <li><a href="register.php"><i class="fa fa-user-circle-o"></i> Create Account</a></li>
               </ul>
            </div>
            ...
            <nav class="navbar navbar-default ">
               ...
               <div class="collapse navbar-collapse js-navbar-collapse" id="bs-example-navbar-collapse-1">
                  <ul class="nav navbar-nav navbar-right">
                     ...
                     <li><a href="search_for_tutor.php">Find Tutors</a></li>
                     <li><a href="search_for_tuition.php">Find Tutions</a></li>
