 ...
 if(isset($_POST['Update']))
{
      ...
      if ($_FILES["PROFILE_IMAGE"]["error"] > 0) 
...

       {
         ...
         $SQL="UPDATE `gen_users`  SET FULL_NAME='$FULL_NAME' , EMAIL='$EMAIL', MOBILE= '$MOBILE', DIVISION_NO='$DIVISION_NO',DISTRICT_NO='$DISTRICT_NO',ADDRESS='$ADDRESS', GENDER_NO='$GENDER_NO', PROFILE_IMAGE='$PROFILE_IMAGE' WHERE `USER_NO`='$USER_NO'";
         $result1 = mysqli_query($conn,$SQL);
         if($result1)
                {
                    $mgs = "Update profile information Successfully"  ;
                    $class = "green_color alert alert-success col-md-6 alert-dismissable";
                   echo "<meta http-equiv='Refresh' content='1; url=update_profile_tutor.php'>";
                }
                else
                {
