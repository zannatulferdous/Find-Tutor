...
<div class="form-group " <?php if($mgs=='')echo "style='display:none;'" ?>>
    ...
    <div class="form-group ">
            <label for="CIRCULAR_TITLE" class="control-label col-lg-3">Old Password</label>
            <div class="col-lg-5">
            ...
            <input type="PASSWORD" class=" form-control" name="OLD_PASS"  >
             ...
             <div class="form-group ">
            <label for="MEDIUM" class="control-label col-lg-3">New Password</label>
            <div class="col-lg-5">
        ...
        <div class="form-group ">
            <label for="MEDIUM" class="control-label col-lg-3">Confirm Password</label>
            <div class="col-lg-5">
